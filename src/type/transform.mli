(**
  ...
  special cases and calls [map] with itself partially applied as an argument to
  handle the other cases where no special treatement is needed.
*)
...
(**
  ...
  special cases and calls [fold] with itself partially applied as an argument
  to handle the other cases where no special treatement is needed.
*)
